...
//Captura evento de submit do fomulário para obter os valores.
form.onsubmit = (event) => {
...
function updateTotals(){
	try{
		...
		//Formata o valor e remove o R$ que será exibido pela small como estilo customizado
...
//Evento que captura o clique nós itens da lista.
